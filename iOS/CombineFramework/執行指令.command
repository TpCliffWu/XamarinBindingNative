...
sharpie -v;
Echo =====產生中繼層======;
sharpie bind --sdk=iphoneos15.0 --output="XamarinApiDef" --namespace="Binding" --scope="Release-fat/MagicTool.framework/Headers/" "Release-fat/MagicTool.framework/Headers/MagicTool-Swift.h";